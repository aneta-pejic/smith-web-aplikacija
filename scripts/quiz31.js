...
const quizData = [
  {
    question: "1. Što mjeri cjenovna elastičnost potražnje (eᴰ)?",
    options: [
  ...
  {
    question: "2. Koja je prednost metode luk-elastičnosti u odnosu na standardnu metodu izračuna?",
    options: [
  ...
  {
    question: "3. Što se događa s apsolutnom vrijednošću cjenovne elastičnosti potražnje kako se krećemo niz linearnu krivulju potražnje?",
    options: [
      "Ostaje konstantna",
      "Raste",
      "Opada",
  ...
  {
    question: "5. Koja je osnovna razlika između nagiba krivulje i elastičnosti?",
    options: [
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="cjenovna_el_potražnje.html" class="btn">Nastavi s učenjem</a>
