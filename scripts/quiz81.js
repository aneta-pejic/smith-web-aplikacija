...
const quizData = [
  {
    question: "1. Što predstavlja granični prihod od faktora (MRP)?",
    options: [
  ...
  {
    question: "2. Kako se izračunava granični prihod od faktora (MRP)?",
    options: [
      "MRP = MP + MR",
      "MRP = MP / MR",
      "MRP = MP * MR",
  ...
  {
    question: "5. Koliko će računovođa gospođa Lancaster zaposliti ako je MFC (granični trošak faktora) 150€, a MRP pada?",
    options: [
      "Sve dok je MRP = 0",
      "Sve dok je MRP > MFC",
      "Sve dok je MRP = MFC",
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="potražnja_za_radom.html" class="btn">Nastavi s učenjem</a>
