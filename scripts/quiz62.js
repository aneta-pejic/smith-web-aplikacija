...
const quizData = [
  ...
  {
    question: "3. Što označava vodoravna linija u modelu savršene konkurencije?",
    options: [
  ...
  {
    question: "4. Ako je tržišna cijena niža od prosječnog ukupnog troška, ali viša od prosječnog varijabilnog troška, što bi poduzeće trebalo učiniti?",
    options: [
  ...
  {
    question: "5. Kako se izračunava ekonomska dobit po jedinici?",
    options: [
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="određivanje_outputa.html" class="btn">Nastavi s učenjem</a>
