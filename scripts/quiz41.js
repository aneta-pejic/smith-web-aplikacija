...
const quizData = [
  ...
  {
    question: "3. Što predstavlja „granična korisnost”?",
    options: [
  ...
  {
    question: "4. Što označava izraz MUx/Px u kontekstu korisnosti?",
    options: [
  ...
  {
    question: "5. Prema pravilu granične odluke, potrošač maksimizira korisnost kada:",
    options: [
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="pojam_korisnosti.html" class="btn">Nastavi s učenjem</a>
