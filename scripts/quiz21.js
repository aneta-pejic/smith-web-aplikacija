...
const quizData = [
  {
    question: "1. Što je krivulja ponude?",
    options: [
      "Grafički prikaz tablice potražnje.",
      "Grafički prikaz tablice ponude."
    ],
    answer: "Grafički prikaz tablice ponude."
  },
  {
    question: "2. Što nije jedno od faktora čije promjene utječu na ponudu?",
    options: [
      "tehnologija",
      "broj kupaca",
      "broj prodavača"
  ...
  {
    question: "3. Povećanje ponude prikazuje se kao pomak krivulje ponude ulijevo.",
    options: [
      "Točno",
      "Netočno"
    ],
  ...
  {
    question: "4. Smanjenje ponude prikazuje se kao pomak krivulje ponude udesno.",
    options: [
      "Točno",
      "Netočno"
    ],
  ...
  {
    question: "5. Mnoge odluke o proizvodnji i prodaji donose se mnogo prije nego što je proizvod spreman za tržište.",
    options: [
      "Točno",
      "Netočno"
    ],
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="ponuda.html" class="btn">Nastavi s učenjem</a>
