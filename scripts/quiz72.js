...
const quizData = [
  {
    question: "1. Koja je ključna razlika između monopola i poduzeća u savršenoj konkurenciji kada je riječ o određivanju cijene?",
    options: [
  ...
  {
    question: "2. Zašto monopol nikada neće odabrati cijenu i količinu u neelastičnom dijelu krivulje potražnje?",
    options: [
  ...
  {
    question: "4. U kojoj točki krivulje potražnje monopol ostvaruje najveći ukupni prihod?",
    options: [
  ...
  {
    question: "5. Što je točno za granični prihod u odnosu na elastičnost potražnje?",
    options: [
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="model_monopola.html" class="btn">Nastavi s učenjem</a>
