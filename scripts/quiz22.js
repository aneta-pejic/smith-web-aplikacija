...
const quizData = [
  {
    question: "1. Promjena cijene dobra ili usluge uzrokuje promjenu tražene količine, što se prikazuje kao...",
    options: [
  ...
  {
    question: "2. Dva dobra su što ako povećanje cijene jednog dobra povećava potražnju za drugim?",
    options: [
      "komplementi",
      "normalna dobra",
      "supstituti"
  ...
  {
    question: "3. Kava i krafne su primjer",
    options: [
      "supstituta",
      "komplemenata"
    ],
  ...
  {
    question: "4. Dobro je inferiorno dobro ako povećanje dohotka povećava potražnju za tim dobrom.",
    options: [
      "Točno",
      "Netočno"
    ],
  ...
  {
    question: "5. Dobro je inferiorno dobro ako povećanje dohotka smanjuje potražnju za tim dobrom.",
    options: [
      "Točno",
      "Netočno"
    ],
...
function showResult() {
  ...
  resultHTML += `
    ...
    <div class="quiz-actions">
      ...
      <a href="potražnja.html" class="btn">Nastavi s učenjem</a>
